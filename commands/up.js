...
module.exports.run = async (Client, msg, args) => {
    ...
    if (!ticketConfig.tiers[ticket.tier + 1]) {
        return msg.channel.send(
            new discord.MessageEmbed({
                ...config.embed
            })
            .setTitle("This is the highest tier!")
        )
    }
    ...
    log(msg.guild, "Ticket moved up!", `${msg.channel} (${msg.channel.id}) has been moved up to tier ${ticket.tier - 1} by ${msg.author} (${msg.author.id})`);
}

module.exports.help = {
    name: "up",
    description: "Move a ticket up the important level.",
    permissions: [],
    alias: [],
    usage: "up",
}